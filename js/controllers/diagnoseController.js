...
diagnose.controller('DiagnoseCtrl', ['$scope', '$http', '$q', '$route','$state', 'DataService', 'TicketService','$rootScope' ,
function ($scope, $http, $q, $route,$state, DataService, TicketService,$rootScope) {
